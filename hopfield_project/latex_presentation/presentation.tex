...
\begin{center}
\textit{[Include figure: retrieval\_noise\_20.png]}\\
\textit{Original → Noisy (20\% flipped) → Retrieved}
\end{center}
...
\begin{center}
\textit{[Include figure: noise\_robustness.png]}\\
\textit{Accuracy vs Noise Level (0-50\%)}
\end{center}
...
\begin{center}
\textit{[Include figure: capacity\_experiment.png]}\\
\textit{Accuracy vs Number of Stored Patterns}
\end{center}
...
\column{0.5\textwidth}
\begin{center}
\textit{[Include figure: spurious\_attractors.png]}\\
\vspace{0.2cm}
\textit{Examples of spurious attractors}
\end{center}
...
\begin{center}
\textit{[Include figure: pattern\_similarity.png]}\\
\textit{Heatmap of normalized overlaps between patterns}
\end{center}
